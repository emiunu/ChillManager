...
public class chillManager {
    ...
    public static void iniciar(){
        ...
        while(condicion){
            mostrarMenus();
            opcion = leerOpcionIniciar();
            ejecutarOpcionIniciar(opcion);
            System.out.print("¿Desea realizar otra operación? (1 = Sí ; 2 = No): ");
            condicion = continuarMenu();
        }
        System.out.println("Cerrando menú... ¡Hasta luego! ^^");
        scanner().close();
    }

    public static void ejecutarOpcionIniciar(int opcion){
        if (opcion == 1) { //menu libros

        } else if (opcion == 2) { //menu juegos
            gameMenu();
        } else if (opcion == 3) { //menu series
            menuSeries();
        } else if (opcion == 4) { //menu peliculas
            menuPeliculas();
    ...
    public static int leerOpcionIniciar(){
        int opcion;
        while (true){
            try{
    ...
    public static void mostrarMenus(){
        System.out.println("Chill Manager: ");
    ...
    //Funciones de series.
        ...
        //Función menú de series.
        public static void menuSeries(){
            Object [][] matrizSeries = matrizSeries();
            boolean continuar = true;
            while(continuar){
    ...
    //Función de ejecutar las opciones del menú.
    public static void ejecutarOpcionLibros(Object[][] matrizSeries, int opcion){
        if (opcion == 1) { //agregar
        } else if (opcion == 2) { //buscar.
        } else if (opcion == 3) { //actualizar.
        } else if (opcion == 4) { //eliminar.
    ...
    public static void menuLibros(){
        Object [][] matrizLibros = matrizLibros();
        boolean continuar = true;
        while(continuar){
    ...
    public static boolean espacioDisponibleLibros(Object[][] matrizLibros){
        for (int i = 0; i < matrizLibros.length; i++) {
            if (matrizLibros[i][0] == null){
    ...
    public static String transformarStatusLibros(int opcion){
        String status = "";
        if (opcion == 1){
            status = "Sin leer.";
        } else if (opcion == 2){
